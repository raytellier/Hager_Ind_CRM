...
namespace Hager_Ind_CRM.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public CountriesController(HagerIndContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,OrderID")] Country country)
        {
            if (ModelState.IsValid)
            {
                country.OrderID = _context.Countries.Count() + 1;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,OrderID")] Country country)
        {
            if (id != country.ID)
            {
                return NotFound();
