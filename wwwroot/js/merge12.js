...
document.getElementById("toggle_Active").onclick = function () {
    ...
    if (!this.checked) {
        ...
        document.getElementById("input_Active").value = document.getElementById("active1").value;

    }
    else {

        document.getElementById("input_Active").value = document.getElementById("active2").value;
    }
};
...
document.getElementById("toggle_CreditCheck").onclick = function () {
    ...
    if (!this.checked) {
        ...
        document.getElementById("input_CreditCheck").value = document.getElementById("creditCheck1").value;

    }
    else {

        document.getElementById("input_CreditCheck").value = document.getElementById("creditCheck2").value;
    }
};
